...
export const INITIATIVE_LIFECYCLE_PLP_INVENTORY = [
  ...
  // Improvement Proposals Part D (CT-owned; Cap02 currentIssue schema retired)
  {
    stageId: "improvement_proposal",
    entityKind: "improvement_proposal",
    fieldPath: "title",
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.title",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  {
    stageId: "improvement_proposal",
    ...
    fieldPath: "summary",
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.summary",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  {
    stageId: "improvement_proposal",
    ...
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.description",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  {
    stageId: "improvement_proposal",
    ...
    fieldPath: "reason",
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.reason",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  {
    stageId: "improvement_proposal",
    entityKind: "improvement_proposal",
    fieldPath: "expectedImprovement",
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.expectedImprovement",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  {
    stageId: "improvement_proposal",
    entityKind: "improvement_proposal",
    fieldPath: "supportingSources",
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.supportingSources",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  {
    stageId: "improvement_proposal",
    entityKind: "improvement_proposal",
    fieldPath: "relatedDiscussionReferences",
    ownership: "MACHINE_CONTENT",
    canonicalSource: "InitiativeStructuredProposal.relatedDiscussionReferences",
    migrationStatus: "ADAPTER_READY_CONSUMER_LEGACY",
  },
  // Revision
  {
