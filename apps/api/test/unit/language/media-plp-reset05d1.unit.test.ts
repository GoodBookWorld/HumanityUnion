...
function emptyReport(
  ...
  return {
    ...
    EDITORIAL_STALE_WORK_VERSION: null,
    EDITORIAL_STALE_CURRENT_SOURCE_VERSION: null,
    EDITORIAL_STALE_BOUNDARY: null,
    EDITORIAL_STALE_AUTHORITY: null,
    EDITORIAL_STALE_ORIGIN_ID: null,
    EDITORIAL_PROVIDER_FAILURE_SUBTYPE: null,
    EDITORIAL_PROVIDER_HTTP_CLASS: null,
    EDITORIAL_PROVIDER_FINISH_REASON: null,
    EDITORIAL_PROVIDER_CANDIDATE_COUNT: null,
    EDITORIAL_PROVIDER_TEXT_PART_COUNT: null,
    EDITORIAL_PROVIDER_EXTRACTED_LENGTH: null,
    EDITORIAL_PROVIDER_EXPECTED_KEY_COUNT: null,
    EDITORIAL_PROVIDER_RETURNED_KEY_COUNT: null,
    EDITORIAL_PROVIDER_MISSING_KEY_COUNT: null,
    EDITORIAL_PROVIDER_BATCH_INDEX: null,
    EDITORIAL_PROVIDER_BATCH_COUNT: null,
