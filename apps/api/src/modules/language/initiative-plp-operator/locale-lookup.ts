/**
 * RESET 05B — Language Registry eligibility (thin read).
 */
...
export type InitiativePlpLocaleLookup = {
  readonly LOCALE_REGISTRY_FOUND: boolean;
  readonly LOCALE_ENABLED: boolean;
  readonly CONTENT_TRANSLATION_ENABLED: boolean;
};

export async function loadInitiativePlpOperatorLocale(
  locale: LanguageCode,
): Promise<InitiativePlpLocaleLookup> {
