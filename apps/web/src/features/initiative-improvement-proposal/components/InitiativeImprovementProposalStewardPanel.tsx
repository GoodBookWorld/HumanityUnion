...
export function InitiativeImprovementProposalStewardPanel({
  ...
  return (
    <div className="initiative-improvement-proposal-steward-panel">
      <p className="initiative-improvement-proposal-steward-panel__note">
        As initiative steward, record your decision on submitted improvement proposals. Accepting a
        proposal records your decision only; it does not edit the initiative.
      </p>

      {loading ? (
        <p className="initiative-improvement-proposal-steward-panel__empty">
          Loading submissions...
        </p>
      ) : null}
      ...
      {!loading && proposals.length === 0 ? (
        <p className="initiative-improvement-proposal-steward-panel__empty">
          No submitted improvement proposals awaiting decision.
        </p>
      ) : null}
